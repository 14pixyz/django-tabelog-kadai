...
SECRET_KEY = 'django-insecure-4(__^^j^4l-ag=y$38he_+64_in-^qcyxx2ey(bc6g*bic7c9)'
...
AUTH_USER_MODEL = 'tabelog.CustomUser' #追加(アプリ名に変更する必要あり)
...
ACCOUNT_LOGOUT_REDIRECT_URL = '/accounts/signup/'  # ログアウト成功後の遷移先の指定
